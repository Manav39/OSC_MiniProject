...
const MyAccount = () => {
  ...
  useEffect(() => {
    ...
    const fetchData = async () => {
      try {
        const alumnusDetailsRes = await axios.get(
          `http://localhost:3000/auth/alumnusdetails?id=${alumnus_id}`
        );
        const coursesRes = await axios.get(
          "http://localhost:3000/auth/courses"
        );
  ...
  const handleSubmit = async (event) => {
    ...
    try {
      ...
      const response = await axios.put(
        "http://localhost:3000/auth/upaccount",
        formData,
        {
          headers: {
          ...
          <div className="row justify-content-center">
            <div className="col-lg-8">
              <form onSubmit={handleSubmit} className="form-horizontal">
                ...
                <div id="msg" className="alert alert-info" role="alert"></div>
                <div className="form-group row">
